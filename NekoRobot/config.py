...
class Config(object):
    ...
    API_ID = 24810254  # integer value, dont use ""
    API_HASH = "aadb42caec01695fa0a77c09b3e0ef47"
    TOKEN = "7766680940:AAFRLQDTwpbreK-dZ-kk8fupB6tHkMBwk2g"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    STRING_SESSION = "12345abc6"
    OWNER_ID = 7543269959  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    ...
    REDIS_URL = ""
    LOAD = []
    NO_LOAD = ["cleaner", "connection", "math"]
    WEBHOOK = True
    INFOPIC = True
    URL = None
